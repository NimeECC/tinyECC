...
public class show_ecdsa implements MessageListener
{
    int round = 0;
    ...
    {
	if(argv.length != 1){
	    System.out.println("Usage: java show_ecdsa [micaz|telosb|imote2]");
	}else{
	    try{
		new show_ecdsa(argv[0]);
	    }catch (Exception e){
    ...
    public show_ecdsa(String platform) throws Exception
    {
